...
public class NaiveBayes_word {
	...
	public static void main(String[] args) throws IOException {
		...
		job1.setJarByClass(NaiveBayes_word.class);
...
//		job1.setCombinerClass(WordCountsReduce.class);
		...
		job2.setJarByClass(NaiveBayes_word.class);
...
//		job2.setCombinerClass(ClassTotalWordsReduce.class);
		...
		job3.setJarByClass(NaiveBayes_word.class);
...
//		job3.setCombinerClass(ClassDiffTotalWordsReduce.class);
		...
		job4.setJarByClass(NaiveBayes_word.class);
